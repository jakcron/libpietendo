...
PROJECT_SRC_SUBDIRS = $(PROJECT_SRC_PATH) $(PROJECT_SRC_PATH)/es $(PROJECT_SRC_PATH)/ctr $(PROJECT_SRC_PATH)/ctr/es $(PROJECT_SRC_PATH)/hac $(PROJECT_SRC_PATH)/hac/es $(PROJECT_SRC_PATH)/hac/pki
