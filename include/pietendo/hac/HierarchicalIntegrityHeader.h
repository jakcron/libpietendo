	/**
	 * @file HierarchicalIntegrityHeader.h
	 * @brief Declaration of pie::hac::HierarchicalIntegrityHeader
	 * @author Jack (jakcron)
	 * @version 0.1
	 * @date 2022/06/28
	 **/
#pragma once
#include <pietendo/hac/define/hierarchicalintegrity.h>
...
public:
	...
	const std::vector<pie::hac::detail::sha256_hash_t>& getMasterHashList() const;
	void setMasterHashList(const std::vector<pie::hac::detail::sha256_hash_t>& master_hash_list);
private:
	...
	std::vector<pie::hac::detail::sha256_hash_t> mMasterHashList;
};
