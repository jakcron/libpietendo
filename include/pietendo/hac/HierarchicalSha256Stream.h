...
private:
	...
	size_t mDataStreamFinalBlockIndex;
	size_t mDataStreamFinalBlockSize;
	...
	inline size_t getSizeOfBlock(size_t block) { return block < mDataStreamFinalBlockIndex ? mDataStreamBlockSize : mDataStreamFinalBlockSize; }
