	/**
	 * @file GameCardHeader.h
	 * @brief Declaration of pie::hac::GameCardHeader
	 * @author Jack (jakcron)
	 * @version 0.1
	 * @date 2022/06/28
	 **/
...
public:
	...
	const std::vector<pie::hac::gc::HeaderFlags>& getFlags() const;
	void setFlags(const std::vector<pie::hac::gc::HeaderFlags>& flags);
	...
	const pie::hac::detail::aes_iv_t& getAesCbcIv() const;
	void setAesCbcIv(const pie::hac::detail::aes_iv_t& iv);
	...
	const pie::hac::detail::sha256_hash_t& getPartitionFsHash() const;
	void setPartitionFsHash(const pie::hac::detail::sha256_hash_t& hash);
	const pie::hac::detail::sha256_hash_t& getInitialDataHash() const;
	void setInitialDataHash(const pie::hac::detail::sha256_hash_t& hash);
	...
	const pie::hac::gc::upp_hash_t& getUppHash() const;
	void setUppHash(const pie::hac::gc::upp_hash_t& hash);
...
private:
	...
	std::vector<pie::hac::gc::HeaderFlags> mFlags;
	uint64_t mPackageId;
	uint32_t mValidDataEndPage;
	pie::hac::detail::aes_iv_t mAesCbcIv;
	uint64_t mPartitionFsHeaderAddress;
	uint64_t mPartitionFsHeaderSize;
	pie::hac::detail::sha256_hash_t mPartitionFsHeaderHash;
	pie::hac::detail::sha256_hash_t mInitialDataHash;
	uint32_t mSelSec;
	uint32_t mSelT1Key;
	uint32_t mSelKey;
	...
	pie::hac::gc::upp_hash_t mUppHash;
	uint64_t mUppId;
};
